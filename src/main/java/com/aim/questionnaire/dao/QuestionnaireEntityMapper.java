...
//     */
    ...
    List<QuestionnaireEntity> select(QuestionnaireEntity entity);

    QuestionnaireEntity selectById(String id);

    void updateStatusById(QuestionnaireEntity entity);

    void deleteById(String questionId);

    void updateById(QuestionnaireEntity entity);

    List<QuestionnaireEntity> queryDeletedListByCreatedBy(QuestionnaireEntity entity);

    List<QuestionnaireEntity> queryAllQuestionnaireByCreated(@Param("createdBy") String createdBy);
